...
import { Settings, Cpu, Zap, Target, Gauge, ExternalLink } from 'lucide-react';
        ...
        <CardContent className="space-y-6">
          ...
          <div>
            ...
            <p className="text-xs text-gray-500 mt-1">
              تأكد من تشغيل خادم Python على Railway
            </p>
          </div>
          ...
          <div className="bg-purple-50 dark:bg-purple-900/20 p-4 rounded-lg">
            ...
            <ul className="text-sm text-purple-700 dark:text-purple-400 space-y-1">
              ...
              <li>• ارفع ملفات الخادم الخلفي مع requirements.txt</li>
              <li>• أضف متغيرات البيئة: PORT=8000</li>
              <li>• تأكد من وجود ملف main.py كنقطة بداية</li>
